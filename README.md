...
## Acknowledgement
Our code is based on the implementation of "Clothflow: A flow-based model for clothed person generation" (See the citation below), including the implementation of the feature pyramid networks (FPN), the ResUnetGenerator, and the cascaded structure to predict the appearance flows. Thanks for their excellent work! If you use our code, please also cite their work as below.
