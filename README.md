...
3. During test, a person image, a clothes image and its extracted edege are fed into the network to generate the try-on image. **No human parsing results or human pose estimation results are needed for test.**
4. To test with the models, run **test.sh** and the results will be saved in the folder "results".
